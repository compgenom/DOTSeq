...
```{r plot-heatmap, warning=FALSE, fig.width=4, fig.height=7, fig.align="center", out.width="325px"}
plotDOT(
    plot_type = "heatmap", 
...
annotations, allowing interpretation of DOU across conditions. If 
the ID mapping dataframe provided, the gene symbol is displayed as 
the plot title.

```{r plot-usage-gene-symbol, eval = requireNamespace("ggsignif", quietly = TRUE)}
gene_id <- "TAF2"
