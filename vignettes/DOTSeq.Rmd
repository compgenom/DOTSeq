...
according to the gene IDs listed in the rowData/rowRanges. This enable 
us to generate ORF usage plots using stable gene identifiers, which is 
especially useful when gene symbols are ambiguous.
