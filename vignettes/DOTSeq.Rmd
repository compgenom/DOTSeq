...
`DOTSeq` builds on the Bioconductor ecosystem, e.g., `rtracklayer`, 
`txdbmaker`, and `GenomicFeatures` for parsing GTF files and annotation 
features and the `SummarizedExperiment` container for storing count 
