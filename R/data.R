...
#'     \code{replicate}.
#'
#' @param flattened_gtf Optional path to a flattened GFF/GTF file containing
#'     exon definitions.
#'
...
#'     }
#'
#' @importFrom SummarizedExperiment SummarizedExperiment assay colData colData<-
...
#'     annotated.
#'
#' @return A \code{GRanges} object with an added metadata column \code{orf_type},
#'     containing the BED score for overlapping ORFs. Non-overlapping ORFs will
#'     have \code{NA}.
#'
